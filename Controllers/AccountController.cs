    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    // 🔹 Assign new users to Customer role
                    ...
                    // Optional: Redirect based on role or show success message
                    TempData["SuccessMessage"] = "Registration successful! Welcome to African Beauty Trading.";
